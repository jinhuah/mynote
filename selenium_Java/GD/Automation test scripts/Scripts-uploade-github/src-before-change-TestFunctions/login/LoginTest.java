...
public class LoginTest extends TestFunctionsBase {
	...
	/**
	 * Test login will success when correct credentials are provided.
	 */
	@Override
	@Test
	public void login() {
	...
	/**
	 * Test when navigate away from URL then navigate back to URL, no login is required if the cookie exists.
	 */
	@Test
	...
	/**
	 * Test when navigate away from URL then navigate back to URL, a login is required if the cookie is deleted.
