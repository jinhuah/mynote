...
public class TestFunctionsBase {
	...
	/**
	 * A function of configuring and launching a browser
	 */
	...
	/**
	 * A function of login the test server.
	 */
	public void login() {
	...
	/**
	 * A function of creating a query by drag and drop "Product Family" and "Store Name" to Columns and Rows fields
	 */
	...
	/**
	 * A function of creating a query by clicking "Product Family" and "Store Name" to Columns and Rows fields
	 */
	...
	/**
	 * A function of dragging an element and drop to a target place
	 */
	...
	// Delete screenshot directory if it exists, this runs before the test suite starts running
	@BeforeSuite
	...
	/**
	 * A function of taking a screenshot and saving into a folder
	 */
	public void takeScreenshot(ITestResult result, String browser, String platform) {
		...
		// Print the screenshot directory in the log
		Reporter.log(screenshotPath);
		Reporter.log("screenshot saved at " + screenshotFile);
		Reporter.log("<a href=\"" + screenshotFile + "\"> <img src=\"" + screenshotFile + "\" height='100' width='100'/> </a>");
