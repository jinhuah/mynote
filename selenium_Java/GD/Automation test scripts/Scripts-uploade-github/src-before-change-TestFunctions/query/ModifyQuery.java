...
public class ModifyQuery extends TestFunctionsBase {
	...
	/**
	 * Tests when an item is adding into Filter field, a new query output will be generated.
	 */
	@Test
	...
	/**
	 * Tests when an item is adding, a new query output will be generated.
	 */
	@Test
	...
	/**
	 * Tests zoom in button brings a new close look of the selected item.
	 */
	@Test
